/********************************************************************************************************************************************
 * 
 * SH1107 드라이버 1.5" 128x128 OLED 디스플레이 사용하는 예제
 * 
 * 구매처 : https://ko.aliexpress.com/item/4000080365758.html?spm=a2g0o.order_list.order_list_main.35.21ef140f0BZpQN&gatewayAdapt=glo2kor
 * 
 * 통신 방식 : 4-SPI
 * 
 * 연결
